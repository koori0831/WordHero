...
{
    public class PlayerSwordCast : PlayerStates
    {
        public PlayerSwordCast(StateMachine stateMachine, Agent owner, int animationHash, bool isSkillAnimation) : base(stateMachine, owner, animationHash, isSkillAnimation)
        {
        }
